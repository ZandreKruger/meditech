...
if ( ! function_exists( 'sampledata_import_files' ) ) :
	function sampledata_import_files() {
		return array(
			array(
				'import_file_name'            => 'doclice',
				'local_import_file'           => trailingslashit( get_stylesheet_directory() ) . 'custom/one-click/doclice_export.xml',
				'local_import_customizer_file'=> trailingslashit( get_stylesheet_directory() ) . 'custom/one-click/doclice_customizer_export.dat',
				'local_import_widget_file'    => trailingslashit( get_stylesheet_directory() ) . 'custom/one-click/doclice_widgets_settings.wie',
...
if ( ! function_exists( 'sampledata_after_import' ) ) :
	function sampledata_after_import($selected_import) {
		...
		if ( class_exists( 'RevSlider' ) ) {
			$slider_array = array(
				get_stylesheet_directory()."/custom/one-click/doclice_slider.zip",
			//	get_stylesheet_directory()."/custom/one-click/doclice_video_slider.zip",
			);
